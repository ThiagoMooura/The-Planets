...
function over(){
    ...
    document.querySelector('.btn1').style.border='1px solid #2d68f0';
    document.querySelector('.btn1-spn').style.color='#fff';
    document.getElementById("botao1").style.backgroundColor='#2d68f0';
    ...
    document.querySelector('.btn1-1').style.borderBottom='4px solid #2d68f0';
...
function int(){
    ...
    document.querySelector('.btn2').style.border='1px solid #2d68f0';
    document.getElementById("botao2").style.backgroundColor='#2d68f0';
    ...
    document.querySelector('.btn2-1').style.borderBottom='4px solid #2d68f0';
    document.querySelector('.btn2-1').style.borderBottom='4px solid #2d68f0';
    document.querySelector('.btn3-1').style.borderBottom='4px solid transparent';
...
function surf(){
    ...
    document.querySelector('.btn3').style.border='1px solid #2d68f0';
    document.getElementById("botao3").style.backgroundColor='#2d68f0';
    ...
    document.querySelector('.btn3-1').style.borderBottom='4px solid #2d68f0';
    document.querySelector('.btn3-1').style.borderBottom='4px solid #2d68f0';
    document.querySelector('.btn2-1').style.borderBottom='4px solid transparent';
    document.querySelector('.btn1-1').style.borderBottom='4px solid transparent';   
}