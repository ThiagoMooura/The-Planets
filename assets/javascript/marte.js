...
function over(){
    ...
    document.querySelector('.btn1').style.border='1px solid #d14e33';
    document.querySelector('.btn1-spn').style.color='#fff';
    document.getElementById("botao1").style.backgroundColor='#d14e33';
    ...
    document.querySelector('.btn1-1').style.borderBottom='4px solid #d14e33';
...
function int(){
    ...
    document.querySelector('.btn2').style.border='1px solid #d14e33';
    document.getElementById("botao2").style.backgroundColor='#d14e33';
    ...
    document.querySelector('.btn2-1').style.borderBottom='4px solid #d14e33';
    document.querySelector('.btn2-1').style.borderBottom='4px solid #d14e33';
    document.querySelector('.btn3-1').style.borderBottom='4px solid transparent';
...
function surf(){
    ...
    document.querySelector('.btn3').style.border='1px solid #d14e33';
    document.getElementById("botao3").style.backgroundColor='#d14e33';
    ...
    document.querySelector('.btn3-1').style.borderBottom='4px solid #d14e33';
    document.querySelector('.btn3-1').style.borderBottom='4px solid #d14e33';
    document.querySelector('.btn2-1').style.borderBottom='4px solid transparent';
    document.querySelector('.btn1-1').style.borderBottom='4px solid transparent';   
}