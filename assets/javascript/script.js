...
function over(){
    ...
    document.querySelector('.btn1').style.border='1px solid #419db9';
    document.querySelector('.btn1-spn').style.color='#fff';
    document.querySelector('.btn1-1').style.borderBottom='4px solid #419db9';
    document.getElementById("botao1").style.backgroundColor='#419db9';
...
function int(){
    ...
    document.querySelector('.btn1').classList.add('desactive');*/
    document.querySelector('.btn2-spn').style.color='#fff';
    document.querySelector('.btn2-1').style.borderBottom='4px solid #419db9';
    document.querySelector('.btn2').style.border='1px solid #419db9';
    document.getElementById("botao2").style.backgroundColor='#419db9';
...
function surf(){
    ...
    document.querySelector('.btn3-1').style.borderBottom='4px solid #419db9';
    document.querySelector('.btn3').style.border='1px solid #419db9';
    document.getElementById("botao3").style.backgroundColor='#419db9';
